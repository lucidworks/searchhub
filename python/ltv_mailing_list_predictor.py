...
if min(MSE_ridge_int, MSE_ridge_noint, MSE_ridgecv_int, MSE_ridgecv_noint, MSE_lasso, MSE_lasso_noint, MSE_lasso_cv, MSE_lasso_cv_noint, MSE_svr, MSE_svr_full, MSE_rf, MSE_rf_full, MSE_bagg, MSE_bagg_full, MSE_gbr, MSE_gbr_full, MSE_abr, MSE_abr_full) == MSE_ridge_int:
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (variables x3,x4,x5,x6,x7) : MSE = {MSE_gbr1} 
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7) : MSE = {MSE_abr1}""".format(MSE=MSE_abr_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint1, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abrl))
