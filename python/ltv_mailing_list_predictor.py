...
mailing_list = "mailing-list-hive-hive-dev"
...
if min(MSE_ridge_int, MSE_ridge_noint, MSE_ridgecv_int, MSE_ridgecv_noint, MSE_lasso, MSE_lasso_noint, MSE_lasso_cv, MSE_lasso_cv_noint, MSE_svr, MSE_svr_full, MSE_rf, MSE_rf_full, MSE_bagg, MSE_bagg_full, MSE_gbr, MSE_gbr_full, MSE_abr, MSE_abr_full) == MSE_ridge_int:
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=ridge_noint_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=ridgecv_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=ridgecv_noint_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=lasso_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=lasso_noint_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=lasso_cv_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=lasso_cv_noint_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=svr_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=svr_full_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=rf_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=rf_full_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=bagg_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=bagg_full_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=gbr_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=gbr_full_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=abr_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
    ...
    The squared error for this prediction is {se}.""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=abr_full_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1]))
