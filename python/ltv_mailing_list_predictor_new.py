...
# the mention of 'resolved' in the body field

##########################################################################################################
# Number of mails which contain 'resolved' in body field (x8)
##########################################################################################################
...
# the mention of 'commented' in the body field
...
if min(MSE_ridge_int, MSE_ridge_noint, MSE_ridgecv_int, MSE_ridgecv_noint, MSE_lasso, MSE_lasso_noint, MSE_lasso_cv, MSE_lasso_cv_noint, MSE_svr, MSE_svr_full, MSE_rf, MSE_rf_full, MSE_bagg, MSE_bagg_full, MSE_gbr, MSE_gbr_full, MSE_abr, MSE_abr_full) == MSE_ridge_int:
    ...
    print ("""The chosen model is a ridge regression model with an intercept; built with variables x3, x4, x5, x6, x7, x8 and x9. 
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Ridge regression model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_ridge_noint1}
        - Ridge regression model w/ intercept, (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_int1}
        - Ridge regression model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_noint1}
        - Lasso model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso1}
        - Lasso model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso_noint1}
        - Lasso model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_lasso_cv1}
        - Lasso model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_lasso_cv_noint1}
        - Support Vector Regression model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_svr1}
        - Support Vector Regression model (all variables) : MSE = {MSE_svr_full1}
        - Random forest model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_rf1}
        - Random forest model (all varibles) : MSE = {MSE_rf_full1}
        - Bagging model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_bagg1}
        - Bagging model (all variables) : MSE = {MSE_bagg_full1}
        - Gradient boosting regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_gbr1} 
        ...
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_ridge_int, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso, MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a ridge regression model without an intercept, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Ridge regression model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_ridge_int1}
        - Ridge regression model w/ intercept, (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_int1}
        - Ridge regression model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_noint1}
        - Lasso model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso1}
        - Lasso model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso_noint1}
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_ridge_noint, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a ridge regression model with an intercept, where the optimal alpha value has been selected by 10-fold cross-validation, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_ridgecv_int, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a ridge regression model without an intercept, where the optimal alpha value has been selected by 10-fold cross-validation, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_ridgecv_noint, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a lasso model with an intercept, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_lasso, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a lasso model without an intercept, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_lasso_noint, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a lasso model with an intercept, where the optimal alpha value has been selected by 10-fold cross-validation. Built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_lasso_cv, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a lasso model without an intercept, where the optimal alpha value has been selected by 10-fold cross-validation, Built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_lasso_cv_noint, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a Support Vector Regression model, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_svr, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a Support Vector Regression model, built using all 9 variables.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_svr_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a random forest model, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_rf, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a random forest model, built using all 9 variables.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_rf_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a bagging model, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_bagg, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a bagging model, built using all 9 variables.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_bagg_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a gradient boosting regressor model, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Ridge regression model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_ridge_int1}
        - Ridge regression model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_ridge_noint1}
        - Ridge regression model w/ intercept, (variables x3,x4,x5,x6,x7; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_int1}
        - Ridge regression model w/o intercept (variables x3,x4,x5,x6,x7; alpha selected by 10-fold CV) : MSE = {MSE_ridgecv_noint1}
        - Lasso model w/ intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso1}
        - Lasso model w/o intercept (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_lasso_noint1}
        - Lasso model w/ intercept (variables x3,x4,x5,x6,x7; alpha selected by 10-fold CV) : MSE = {MSE_lasso_cv1}
        - Lasso model w/o intercept (variables x3,x4,x5,x6,x7; alpha selected by 10-fold CV) : MSE = {MSE_lasso_cv_noint1}
        - Support Vector Regression model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_svr1}
        - Support Vector Regression model (all variables) : MSE = {MSE_svr_full1}
        - Random forest model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_rf1}
        - Random forest model (all varibles) : MSE = {MSE_rf_full1}
        ...
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_gbr, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is a gradient boosting regressor model, built using all 9 variables.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_gbr1} 
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_gbr_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_abr1=MSE_abr, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is an AdaBoost regressor model, built with variables x3, x4, x5, x6, x7, x8 and x9.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_gbr1} 
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (all variables) : MSE = {MSE_abr_full1}""".format(MSE=MSE_abr, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr_full1=MSE_abr_full))
    ...
    print ("""The chosen model is an AdaBoost regressor model, built using all 9 variables.
    ...
    Other models taken into consideration, and their respective MSE values were:
        ...
        - Gradient boosting regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_gbr1} 
        - Gradient boosting regressor model (all variables) : MSE = {MSE_gbr_full1}
        - AdaBoost regressor model (variables x3,x4,x5,x6,x7,x8,x9) : MSE = {MSE_abr1}""".format(MSE=MSE_abr_full, contrib=contributor, mail_list=mailing_list, r2=ridge_int_r2, num_of_mails_1=str(y_prediction)[2:][:-1], num_of_mails_2=y_value, se=str(squared_error)[2:][:-1], MSE_ridge_int1=MSE_ridge_int, MSE_ridge_noint1=MSE_ridge_noint, MSE_ridgecv_int1=MSE_ridgecv_int, MSE_ridgecv_noint1=MSE_ridgecv_noint, MSE_lasso1=MSE_lasso,MSE_lasso_noint1=MSE_lasso_noint, MSE_lasso_cv1=MSE_lasso_cv, MSE_lasso_cv_noint1=MSE_lasso_cv_noint, MSE_svr1=MSE_svr, MSE_svr_full1=MSE_svr_full, MSE_rf1=MSE_rf, MSE_rf_full1=MSE_rf_full, MSE_bagg1=MSE_bagg, MSE_bagg_full1=MSE_bagg_full, MSE_gbr1=MSE_gbr, MSE_gbr_full1=MSE_gbr_full, MSE_abr1=MSE_abr))
