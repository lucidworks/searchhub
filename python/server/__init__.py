...
parser.add_argument('--create_typeahead_collection', action='store_true',
                            help='create/update the typeahead collection')
...
parser.add_argument('--activate_autocorrect_typeahead', action='store_true',
